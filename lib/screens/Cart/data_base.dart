...
class DBHelper {
  ...
  _onCreate(Database db, int version) async {
    await db.execute(
        'CREATE TABLE cart(id INTEGER PRIMARY KEY , productId VARCHAR UNIQUE, productName TEXT, restaurantName TEXT , identity TEXT, menutype TEXT ,initialPrice INTEGER, productPrice INTEGER, quantity INTEGER, categoryTag TEXT, image TEXT)');
  }
