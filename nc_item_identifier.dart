...
import 'package:flutter_2/WishlistScreen/data_base.dart';
import 'package:flutter_2/WishlistScreen/wishlist_model.dart';
...
class _NCMainCourseState extends State<NCMainCourse> {
  ...
  Widget build(BuildContext context) {
    ...
    DBHelperWishlist dbHelperWishlist = DBHelperWishlist();
    void saveWishlistData(int index) {
      dbHelperWishlist
          .wishlistInsert(
            Wishlist(
              id: index,
        ...
        onTap: () {
          showDialog(
              ...
              builder: (context) {
                ...
                colors: [Colors.black.withOpacity(0.7),Colors.transparent,Colors.transparent,Colors.transparent,Colors.transparent,Colors.transparent,Colors.transparent, Colors.black.withOpacity(0.5)],
                begin: Alignment.topCenter,
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              productsNC[widget.menuindex].category,
                                ...
                                onTap: () {
                                  if (provider.cart.isEmpty) {
                                    ...
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      ...
                                      .contains(
                                          (productsNC[this.widget.menuindex]
                                              .identity)))) {
                                    showDialog(
                                      context: context,
